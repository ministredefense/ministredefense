...
document.addEventListener('DOMContentLoaded', async () => {
    ...
    searchInput.oninput = () => filterUsers(searchInput.value.trim().toLowerCase());
    ...
    function createCard(u) {
        ...
        card.innerHTML = `
            ...
            <div class="point-id">Номер акаунта: ${escapeHtml(u.accountId)}</div>
            <div class="point-total">Баллов: <strong>${u.totalPoints}</strong> (+${u.totalEarned}/-${u.totalSpent})</div>
        `;
